...
class Instrumenttype_model extends MY_Model
{
	...
	public function getinstrumenttypes($opts=array())
	{
		...
		if($type!='')
		{
			$opts['condition'].= " AND ins_type='$type'";
		}
		if($keyword!='')
		{
		...
		$result = $this->findAll('tbl_instrument_type as a',$fetch_config);
		return $result;
	}
	...
	public function get_instrument_type_by_id($id)
	{
		...
		if($id>0)
		{
			...
			$result = $this->find('tbl_instrument_type',$fetch_config);
			return $result;
		}
	}
}
