...
class Instcat_model extends MY_Model
{
	...
	public function getinstcategory($opts=array())
	{
		...
		if($keyword!='')
		{
			$opts['condition'].= " AND cat_name like '%".$keyword."%'";
		}
		...
		$result = $this->findAll('tbl_instrument_category as a',$fetch_config);
		return $result;
	}
	...
	public function get_instrument_category_by_id($id)
	{
		...
		if($id>0)
		{
			...
			$result = $this->find('tbl_instrument_category',$fetch_config);
			return $result;
		}
	}
}
