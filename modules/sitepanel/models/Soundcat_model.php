...
class Soundcat_model extends MY_Model
{
	...
	public function getsoundcategory($opts=array())
	{
		...
		$result = $this->findAll('tbl_sound_category as a',$fetch_config);
		return $result;
	}
	...
	public function get_sound_category_by_id($id)
	{
		...
		if($id>0)
		{
			...
			$result = $this->find('tbl_sound_category',$fetch_config);
			return $result;
		}
	}
}
