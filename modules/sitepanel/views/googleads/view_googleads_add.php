<div id="content">
 ...
 <div class="box">
  ...
  <div class="content">
   ...
   <?php echo form_open_multipart('sitepanel/googleads/add/');?>
   <table width="90%"  class="tableList" align="center">
    <tr><th colspan="2" align="center" > </th></tr>
    <tr class="trOdd">
     <td width="253" height="26"> Google Ad Content : <span class="required">*</span></td>
     <td width="597"><textarea name="gad_content" rows="15" style="width:525px;" id="gad_content" ><?php echo set_value('gad_content');?></textarea></td>
    </tr>
    <tr class="trOdd">
     <td align="left">&nbsp;</td>
     <td align="left">
