...
<div id="content">
 <div class="breadcrumb"><?php echo anchor('sitepanel/dashbord','Home');?> &raquo; <?php echo anchor('sitepanel/manage_prices/virtual_instrument_price','Back To Listing'); ?> &raquo; <?php echo $heading_title;?></div>
 <div class="box">
  <div class="heading">
  ...
  <div class="content">
   ...
   <tr class="trOdd">
     ...
     echo common_dropdown("instrument_type", set_value('instrument_type',$res['instrument_type']), $tbl_arr, " style='width:250px;' ", '', '')
	 ?>
     </td>
    </tr>
