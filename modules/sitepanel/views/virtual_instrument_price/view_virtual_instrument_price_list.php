...
<div id="content">
 ...
 <div class="box">
  <div class="heading">
   ...
   <div class="buttons"> <?php echo anchor("sitepanel/manage_prices/add_virtual_price",'<span>Add Price</span>','class="button"');?></div>
  </div>
  <div class="content">
   <?php echo validation_message();
   echo error_message();
   echo form_open("sitepanel/manage_prices/virtual_instrument_price",'id="search_form" method="get"');?>
   <div align="right" class="breadcrumb"> Records Per Page : <?php echo display_record_per_page();?> </div>
   <table width="100%"  border="0" cellspacing="3" cellpadding="3">
    <tr>
      <td align="center" >Search 
        <?php
	 $tbl_arr = array('select_fld'=>'id,title','tbl_name'=>'tbl_instrument_type',"where"=>" AND status ='1' AND ins_type='2' ");
     echo common_dropdown("instrument_type",$this->input->get('instrument_type'), $tbl_arr, " style='width:200px;' ", 'Instrument Type', '')
	 ?>&nbsp;
	 ...
	 ?>
      ...
      <a  onclick="$('#search_form').submit();" class="button"><span> GO </span></a> <?php if($this->input->get_post('search')!=''){ echo anchor("sitepanel/manage_prices/virtual_instrument_price/",'<span>Clear Search</span>'); }?>
   ...
   if( is_array($res) && !empty($res)){
	   echo form_open("sitepanel/manage_prices/virtual_instrument_price",'id="data_form"');?>
	    ...
	    <tbody>
		 ...
		 ?>
		     <tr>
		      ...
		      <td class="center"><?php echo anchor("sitepanel/manage_prices/edit_virtual_price/$pageVal[price_id]/".query_string(),'Edit'); ?></td>
		     </tr>
		     <?php
		     $j++;
	     }?>
