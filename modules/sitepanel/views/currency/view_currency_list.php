...
<div id="content">
 ...
 <div class="box">
  ...
  <div class="content">
   ...
   echo form_open("sitepanel/currency/",'id="form" method="get" '); ?>
	   ...
	   <table class="list" width="100%" id="my_data">
	    ...
	    <tbody>
	     ...
	     foreach($res as $catKey=>$pageVal){
		     ?>
		     <tr>
		      <td style="text-align: center;"><?php if($pageVal['is_default']!='Y'){?><input type="checkbox" name="arr_ids[]" value="<?php echo $pageVal['currency_id'];?>" /><?php }?></td>
		      ...
		      <td align="center" >
		       <?php if($pageVal['is_default']!='Y'){
			       echo anchor("sitepanel/currency/edit/$pageVal[currency_id]/".query_string(),'Edit');
		       }else{?>
