  ...
  <div class="content">
   ...
   <table width="90%"  class="form"  cellpadding="3" cellspacing="3">
    ...
    <tr class="trOdd">
     ...
     <td width="72%" align="left"><input type="text" name="title" id="title" size="40" maxlength="32" value="<?php echo set_value('title',$res->title);?>"></td>
    </tr>
    <tr class="trOdd">
     <td width="28%" height="26" align="right" ><span class="required">*</span> Currency Code:</td>
     <td width="72%" align="left"><input type="text" name="code" size="40"  maxlength="3" value="<?php echo set_value('code',$res->code);?>"></td>
    </tr>
    <tr class="trOdd">
     <td width="28%" height="26" align="right" ><span class="required">*</span> Currency Symbol:</td>
     <td width="72%" align="left"><input type="text" name="symbol" size="40" value="<?php echo set_value('symbol',$res->symbol_left);?>"></td>
    </tr>
    <tr class="trOdd">
     <td width="28%" height="26" align="right" ><span class="required">*</span> Currency Value:</td>
     <td width="72%" align="left"><input type="text" name="value" size="40" value="<?php echo set_value('symbol',$res->value);?>"> = 1 USD</td>
    </tr>
    <tr class="trOdd">
     <td align="left">&nbsp;</td>
     <td align="left">
      <input type="submit" name="sub" value="Update Currency" class="button2" />
