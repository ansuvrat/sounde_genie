	...
	<?php if($pageresult['page_short_description']!=''){	 ?>
	 ...
	 ?>	
		...
		<tr class="trEven">
			...
			<textarea name="page_description" rows="5" cols="50" id="page_desc" ><?php echo html_entity_decode($pageresult['page_description']);?></textarea>
...
<input type="hidden" name="action" value="editstaticpage" />
