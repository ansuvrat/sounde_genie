...
<div id="content">
 <div class="breadcrumb">
  <?php echo anchor('sitepanel/dashbord','Home');?> &raquo; <?php echo anchor('sitepanel/manage_prices/sound_recording_price','Back To Listing'); ?> &raquo; <?php echo $heading_title;?>
 </div>
 <div class="box">
  <div class="heading">
  ...
  <div class="content">
   ...
   echo error_message();
   echo form_open_multipart('sitepanel/manage_prices/add_sound_recording_price');?>
   ...
   <table width="90%"  class="tableList" align="center">
    ...
    <tr class="trOdd">
     ...
     echo common_dropdown("sound_recording_category", set_value('sound_recording_category'), $tbl_arr, " style='width:250px;' ", '', '')
	 ?>
     </td>
    </tr>
