	...
	<div id="content">
		...
		<div class="box">
			...
			<div class="content">
				...
				<?php
				$countryID=(@$this->input->get_post('county')!='')?@$this->input->get_post('county'):@$row->country_id;               	
              	$arr=array("tbl_name"=>"tbl_country","select_fld"=>"id,country_name","where"=>"and status='1'");
              	echo common_dropdown('country_id',set_value('country_id',$countryID),$arr,'style="width:235px;"');
