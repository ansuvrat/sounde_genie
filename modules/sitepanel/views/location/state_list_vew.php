<div id="content">
	...
	<div class="box">
		<div class="heading">
			...
			<div class="buttons"><?php echo anchor("sitepanel/".$this->current_controller."/state_add_edit","<span>Add State</span>",'class="button" ' );?></div>
		</div>
		
		<div class="content">
			<?php  echo error_message(); ?>
			
			<?php echo form_open("sitepanel/".$this->current_controller."/state",'id="search_form" method="get" '); ?>
			...
			<table width="100%"  border="0" cellspacing="3" cellpadding="3" >
          	...
          	echo common_dropdown('country_id',$this->input->get_post('country_id'),$arr,'style="width:100px;"');
          	?>
						
						<a  onclick="$('#search_form').submit();" class="button"><span> GO </span></a>
						
						<?php
						if( $this->input->get_post('keyword')!='' || $this->input->get_post('status')!='' || $this->input->get_post('country_id')!='' )
						{
							echo anchor("sitepanel/".$this->current_controller."/state",'<span>Clear Search</span>');
						}
						?>
					</td>
				</tr>
			...
			{
				echo form_open("sitepanel/".$this->current_controller."/state",'id="data_form"');?>
				...
				<table class="list" width="100%" id="my_data">
					<thead>
						<tr>
							...
							<td width="239" class="left">State Name </td>
					...
					foreach($res as $catKey=>$pageVal)
					{
						...
						<tr>
							...
							<td class="left"><?php echo $pageVal['title'];?>					
							</td>	
							<td class="left">
							...
							<td align="center" >
								<?php echo anchor("sitepanel/".$this->current_controller."/state_add_edit/$pageVal[id]/".query_string(),'Edit'); ?>
							</td>
						</tr>
						<?php
					}
