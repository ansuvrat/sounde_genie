...
<div class="box" style="width: 325px; min-height: 500px; margin-top: 40px; margin-left: auto; margin-right: auto;">
  ...
  <div class="content" style="min-height: 150px;">
    ...
    <?php 
	  ...
	  $res = get_db_single_row('tbl_users','username,password'," AND id='1' ");
    ...
    <table style="width: 100%;">
      ...
      <tr>
       ...
       <tr>
         ...
         <td rowspan="4" valign="top" style="text-align: center;"><img src="<?php echo base_url(); ?>assets/sitepanel/image/login.png" alt="Please enter your login details." /></td>
