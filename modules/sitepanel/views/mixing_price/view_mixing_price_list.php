...
<div id="content">
 ...
 <div class="box">
  <div class="heading">
   ...
   <div class="buttons"> <?php echo anchor("sitepanel/manage_prices/add_mixing_price",'<span>Add Price</span>','class="button"');?></div>
  </div>
  <div class="content">
   <?php echo validation_message();
   echo error_message();
   echo form_open("sitepanel/manage_prices/mixing_price",'id="search_form" method="get"');?>
   ...
   <table width="100%"  border="0" cellspacing="3" cellpadding="3">
    <tr>
      <td align="center" >Search 
		...
		for($i=1;$i<=16;$i++){
		?>  
        <option value="<?php echo $i;?>" <?php if($this->input->get_post('track_id')==$i){ echo "Selected";}?>>Track <?php echo $i;?></option>
      <?php } ?>  
        </select>
        &nbsp;
      <?php
	 ...
	 ?>
      (In Minutes)
      <a  onclick="$('#search_form').submit();" class="button"><span> GO </span></a> <?php if($this->input->get_post('search')!=''){ echo anchor("sitepanel/manage_prices/mixing_price/",'<span>Clear Search</span>'); }?>
   ...
   if( is_array($res) && !empty($res)){
	   echo form_open("sitepanel/manage_prices/mixing_price",'id="data_form"');?>
	   <table class="list" width="100%" id="my_data">
	    <thead>
	     <tr>
	      ...
	      <td width="24%" class="left">Tracks</td>
	    ...
	    <tbody>
		 ...
		 ?>
		     <tr>
		      ...
		      <td class="left">Track <?php echo $pageVal['track_id'];?> </td>
		      <td class="left"><?php echo $duration;?> Minutes</td>
		      <td class="center"><?php echo ($pageVal['status']==1)?"Active":"In-active";?></td>
		      <td class="center"><?php echo anchor("sitepanel/manage_prices/edit_mixing_price/$pageVal[price_id]/".query_string(),'Edit'); ?></td>
		     </tr>
		     <?php
		     $j++;
	     }?>
