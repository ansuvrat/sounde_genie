...
<div id="content">
 <div class="breadcrumb">
  <?php echo anchor('sitepanel/dashbord','Home');?> &raquo; <?php echo anchor('sitepanel/manage_prices/mixing_price','Back To Listing'); ?> &raquo; <?php echo $heading_title;?>
 </div>
 <div class="box">
  <div class="heading">
  ...
  <div class="content">
   ...
   echo error_message();
   echo form_open_multipart('sitepanel/manage_prices/add_mixing_price');?>
   ...
   <table width="90%"  class="tableList" align="center">
    ...
    <?php for($i=1;$i<=16;$i++){ ?>
       <option value="<?php echo $i;?>" <?php if($this->input->post('track_id')==$i){ echo "Selected";}?>>Track <?php echo $i;?></option>
    <?php } ?>   
     </select>
     </td>
    </tr>
