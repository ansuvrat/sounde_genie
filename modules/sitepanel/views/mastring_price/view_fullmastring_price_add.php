...
<div id="content">
 <div class="breadcrumb">
  <?php echo anchor('sitepanel/dashbord','Home');?> &raquo; <?php echo anchor('sitepanel/manage_prices/fullmastring_price','Back To Listing'); ?> &raquo; <?php echo $heading_title;?>
 </div>
 <div class="box">
  <div class="heading">
  ...
  <div class="content">
   ...
   echo error_message();
   echo form_open_multipart('sitepanel/manage_prices/add_fullmastring_price');?>
   ...
   <table width="90%"  class="tableList" align="center">
    ...
    <tr class="trOdd">
     ...
     <td width="597"><input type="text" name="price" size="40" value="<?php echo set_value('price');?>">  
     <span id="if_album"> </span>
     </td>
    </tr>
