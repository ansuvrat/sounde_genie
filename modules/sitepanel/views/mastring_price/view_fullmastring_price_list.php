...
<div id="content">
 ...
 <div class="box">
  <div class="heading">
   ...
   <div class="buttons"> <?php echo anchor("sitepanel/manage_prices/add_fullmastring_price",'<span>Add Price</span>','class="button"');?></div>
  </div>
  <div class="content">
   <?php echo validation_message();
   echo error_message();
   echo form_open("sitepanel/manage_prices/fullmastring_price",'id="search_form" method="get"');?>
   <div align="right" class="breadcrumb"> Records Per Page : <?php echo display_record_per_page();?> </div>
   <table width="100%"  border="0" cellspacing="3" cellpadding="3">
    <tr>
      <td align="center" >Search(track) 
      <?php
	 ...
	 ?>
      ...
      <a  onclick="$('#search_form').submit();" class="button"><span> GO </span></a> <?php if($this->input->get_post('search')!=''){ echo anchor("sitepanel/manage_prices/fullmastring_price/",'<span>Clear Search</span>'); }?>
	    ...
	    <tbody>
		 ...
		 ?>
		     <tr>
              ...
              <td class="left">Track <?php echo $pageVal['duration'];?></td>
		      <td class="left"><?php echo $pageVal['price'];?></td>
		      <td class="center"><?php echo ($pageVal['status']==1)?"Active":"In-active";?></td>
		      <td class="center"><?php echo anchor("sitepanel/manage_prices/edit_fullmastring_price/$pageVal[price_id]/".query_string(),'Edit'); ?></td>
		     </tr>
		     <?php
		     $j++;
	     }?>
