...
<div id="content">
 ...
 <div class="box">
  <div class="heading">
   ...
   <div class="buttons"> <?php echo anchor("sitepanel/manage_prices/add_mastring_price",'<span>Add Price</span>','class="button"');?></div>
  </div>
  <div class="content">
   <?php echo validation_message();
   echo error_message();
   echo form_open("sitepanel/manage_prices/mastring_price",'id="search_form" method="get"');?>
   ...
   <table width="100%"  border="0" cellspacing="3" cellpadding="3">
    <tr>
	 ...
	 ?>
      ...
      <a  onclick="$('#search_form').submit();" class="button"><span> GO </span></a> <?php if($this->input->get_post('search')!=''){ echo anchor("sitepanel/manage_prices/mastring_price/",'<span>Clear Search</span>'); }?>
   ...
   if( is_array($res) && !empty($res)){
	   echo form_open("sitepanel/manage_prices/mastring_price",'id="data_form"');?>
	   <table class="list" width="100%" id="my_data">
	    ...
	    <tbody>
	     ...
	     foreach($res as $catKey=>$pageVal){
			 ...
			 $mastring_type = ($pageVal['mastring_type']==1)?"Single Track":"Full Album";
		 ?>
		     <tr>
		      ...
		      <td class="center"><?php echo anchor("sitepanel/manage_prices/edit_mastring_price/$pageVal[price_id]/".query_string(),'Edit'); ?></td>
		     </tr>
		     <?php
		     $j++;
	     }?>
