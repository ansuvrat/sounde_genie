				...
				<div id="tab_pinfo">
					<table width="90%"  class="form"  cellpadding="3" cellspacing="3">
						...
						<tr class="trOdd">
								...
								<td align="left"><input type="text" name="name" size="60" value="<?php echo set_value('name');?>" /></td>
						</tr>
						<tr class="trOdd">
							<td height="26" align="right" >Email Id<span class="required"> * </span>: </td>
							<td align="left"><input type="text" name="email" size="60" value="<?php echo set_value('email');?>" /></td>
						</tr>
