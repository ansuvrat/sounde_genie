	...
	<div id="content">
		...
		<div class="box">
			...
			<div class="content">
				...
				<?php echo form_open_multipart("sitepanel/$this->current_controller/edit/".$prodresult->id);?>
				<div id="tab_pinfo">
					<table width="90%"  class="form"  cellpadding="3" cellspacing="3">
						...
						<tr class="trOdd">
					<td width="38%" height="26" align="right" ><span class="required">*</span> Name:</td>
					<td width="62%" align="left"><input type="text" name="name" size="40" value="<?php echo set_value('name',$prodresult->name);?>"></td>
				</tr>
				<tr class="trOdd">
					<td width="38%" height="26" align="right" ><span class="required">*</span> Email Id:</td>
					<td width="62%" align="left"><input type="text" name="email" size="40" value="<?php echo set_value('email',$prodresult->email);?>"></td>
				</tr>
				
				<tr class="trOdd">
					<td width="38%" height="26" align="right" ><span class="required">*</span> Username:</td>
					<td width="62%" align="left"><input type="text" name="username" size="40" value="<?php echo set_value('username',$prodresult->username);?>"></td>
				</tr>
				<tr class="trOdd">
					<td width="38%" height="26" align="right" ><span class="required">*</span> Password:</td>
					<td width="62%" align="left"><input type="password" name="password" size="40" value="<?php echo set_value('password',$prodresult->password);?>"></td>
				</tr>
				...
				<tr class="trOdd">
					...
					<td align="left">
						...
						<input type="hidden" name="id" value="<?php echo $prodresult->id;?>">
					</td>
				</tr>
					</table>
				</div>
