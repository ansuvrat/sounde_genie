...
<div id="content">
 <div class="breadcrumb">
  <?php echo anchor('sitepanel/dashbord','Home');?> &raquo; <?php echo anchor('sitepanel/manage_prices/lyrics_price','Back To Listing'); ?> &raquo; <?php echo $heading_title;?>
 </div>
 <div class="box">
  <div class="heading">
  ...
  <div class="content">
   ...
   echo error_message();
   echo form_open_multipart('sitepanel/manage_prices/add_lyrics_price');?>
   ...
   <table width="90%"  class="tableList" align="center">
    ...
    <tr class="trOdd">
     <td width="253" height="26" align="right"> Lyrics Type : <span class="required">*</span></td>
     <td width="597">
   <input type="radio" name="lyrics_type" value="1" <?php if($this->input->post('lyrics_type')==1){ echo "checked";}?> /> Single Musical Piece&nbsp;
   <input type="radio" name="lyrics_type" value="2" <?php if($this->input->post('lyrics_type')==2){ echo "checked";}?>/> Full Album Lyrics
     </td>
    </tr>
