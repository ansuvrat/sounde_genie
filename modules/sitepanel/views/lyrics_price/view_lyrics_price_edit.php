...
<div id="content">
 <div class="breadcrumb"><?php echo anchor('sitepanel/dashbord','Home');?> &raquo; <?php echo anchor('sitepanel/manage_prices/lyrics_price','Back To Listing'); ?> &raquo; <?php echo $heading_title;?></div>
 <div class="box">
  <div class="heading">
  ...
  <div class="content">
   ...
   <tr class="trOdd">
     ...
     <td width="597">
     <input type="radio" name="lyrics_type" value="1" <?php if(set_value('lyrics_type',$res['lyrics_type'])==1) echo 'checked'; ?>  /> Single Musical Piece &nbsp;
   <input type="radio" name="lyrics_type" value="2" <?php if(set_value('lyrics_type',$res['lyrics_type'])==2) echo 'checked'; ?> /> Full Album Lyrics
     </td>
    </tr>
