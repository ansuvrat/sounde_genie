...
<div id="content">
 <div class="breadcrumb">
  <?php echo anchor('sitepanel/dashbord','Home');?> &raquo; <?php echo anchor('sitepanel/sound_category','Back To Listing'); ?> &raquo; <?php echo $heading_cat_name;?>
 </div>
 <div class="box">
  <div class="heading">
  ...
  <div class="content">
   ...
   echo error_message();
   echo form_open_multipart('sitepanel/sound_category/add/');?>
