      ...
      <tr>
        <th colspan="2" align="center" > </th>
			...
			<tr class="trOdd">
				...
				<td align="left"><input type="text" name="name" value="<?php echo set_value('name',$row->name);?>" size="40" /> </td>
			</tr>
      
      <tr class="trOdd">
				<td width="28%" height="26" align="right"> <span class="required">*</span> Testimonial Description:</td>
				<td align="left"><textarea name="testimonail_desc" rows="4" cols="100"><?php echo set_value('testimonial_desc',$row->testimonial_desc);?></textarea> </td>
			</tr>
      
      <tr class="trOdd">
        <td align="left">&nbsp;</td>
        <td align="left">
          <input type="submit" name="sub" value="Update Testimonial" class="button2" />
