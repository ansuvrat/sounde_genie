...
$sitepanel_menu_array=$this->admin_lib->get_menu_item();
...
<title><?php echo $this->site_setting['company_name'];?> Administrator Area</title>
...
<div id="header">
  ...
  <div class="div1">
    ...
    <div style=" color: #FFF; font-size: 14px; font-weight: bold;"> <?php echo $this->site_setting['company_name'];?>  Administrator Area</div>
    ...
    <?php echo ($this->admin_type==1)?'You are logged in as administrator':'You are logged in as Subadmin'; ?></div>
  ...
  <div id="menu">
   ...
   <ul class="left" style="display: none;"><?php createMenu($sitepanel_menu_array);?></ul>
    ...
    <ul class="right" style="display: none;">     
      ...
      <li>  <?php echo anchor('sitepanel/logout','Logout',array('class' => "top")); ?> </li>
