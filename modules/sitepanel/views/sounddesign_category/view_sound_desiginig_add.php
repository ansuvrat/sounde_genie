...
<div id="content">
 <div class="breadcrumb">
  <?php echo anchor('sitepanel/dashbord','Home');?> &raquo; <?php echo anchor('sitepanel/managesounddesign/soundlist','Back To Listing'); ?> &raquo; <?php echo $heading_title;?>
 </div>
 <div class="box">
  <div class="heading">
  ...
  <div class="content">
   ...
   echo error_message();
   echo form_open_multipart('sitepanel/managesounddesign/add_price');?>

   <table width="90%"  class="tableList" align="center">
    <tr><th colspan="2" align="center" > </th></tr>
    <tr class="trOdd">
     <td width="253" height="26" align="right"> Category : <span class="required">*</span></td>
     <td width="597">
     <?php
	 $tbl_arr = array('select_fld'=>'id,sounddegn_category','tbl_name'=>'tbl_sounddesign_category',"where"=>" AND status ='1'  ");
     echo common_dropdown("cat_id", set_value('cat_id'), $tbl_arr, " style='width:250px;' ", '', '')
	 ?>
     </td>
    </tr>
    <tr class="trOdd">
