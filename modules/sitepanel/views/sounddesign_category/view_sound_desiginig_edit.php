...
<div id="content">
 <div class="breadcrumb"><?php echo anchor('sitepanel/dashbord','Home');?> &raquo; <?php echo anchor('sitepanel/managesounddesign/soundlist','Back To Listing'); ?> &raquo; <?php echo $heading_title;?></div>
 <div class="box">
  <div class="heading">
  ...
  <div class="content">
   ...
   <tr class="trOdd">
     ...
     echo common_dropdown("cat_id", set_value('instrument_type',$res['cat_id']), $tbl_arr, " style='width:250px;' ", '', '')
	 ?>
     </td>
    </tr>
    <tr class="trOdd">
