...
<div id="content">
 <div class="breadcrumb"><?php echo anchor('sitepanel/dashbord','Home');?> &raquo; <?php echo anchor('sitepanel/managesounddesign','Back To Listing'); ?> &raquo; <?php echo $heading_cat_name;?></div>
 <div class="box">
  <div class="heading">
  ...
  <div class="content">
   ...
   <table width="90%"  class="tableList" align="center">
    ...
    <tr class="trOdd">
     ...
     <td width="597"><input type="text" name="sounddegn_category" size="40" value="<?php echo set_value('sounddegn_category',$res['sounddegn_category']);?>"></td>
    </tr>
