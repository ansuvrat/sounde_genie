...
<div id="content">
 ...
 <div class="box">
  <div class="heading">
   ...
   <div class="buttons"> <?php echo anchor("sitepanel/manage_prices/add_designing_price",'<span>Add Price</span>','class="button"');?></div>
  </div>
  <div class="content">
   <?php echo validation_message();
   echo error_message();
   echo form_open("sitepanel/manage_prices/designing_price",'id="search_form" method="get"');?>
   ...
   <table width="100%"  border="0" cellspacing="3" cellpadding="3">
    <tr>
     ...
     echo common_dropdown("duration", $this->input->get('duration'), $tbl_arr, " style='width:200px;' ", 'Select Duration', '')
	 ?>
      (In Minutes)
     
     
      <a  onclick="$('#search_form').submit();" class="button"><span> GO </span></a> <?php if($this->input->get_post('search')!=''){ echo anchor("sitepanel/manage_prices/designing_price/",'<span>Clear Search</span>'); }?>
   ...
   if( is_array($res) && !empty($res)){
	   echo form_open("sitepanel/manage_prices/designing_price",'id="data_form"');?>
	    ...
	    <tbody>
		 ...
		 ?>
		     <tr>
		      ...
		      <td class="center"><?php echo anchor("sitepanel/manage_prices/edit_designing_price/$pageVal[price_id]/".query_string(),'Edit'); ?></td>
		     </tr>
		     <?php
		     $j++;
	     }?>
