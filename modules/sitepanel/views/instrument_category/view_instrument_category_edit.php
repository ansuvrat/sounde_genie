...
<div id="content">
 <div class="breadcrumb"><?php echo anchor('sitepanel/dashbord','Home');?> &raquo; <?php echo anchor('sitepanel/instrument_category','Back To Listing'); ?> &raquo; <?php echo $heading_cat_name;?></div>
 <div class="box">
  <div class="heading">
