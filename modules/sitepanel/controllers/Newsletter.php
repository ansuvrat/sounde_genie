...

{
   ...
   {  
	...
	public function add()
	{
		...
		$this->form_validation->set_rules('subscriber_name','Name','trim|required|max_length[32]');
		$this->form_validation->set_rules('subscriber_email','Email','trim|required|valid_email|callback_check_record');
					...
					if($this->input->post("submit")!="" ){
					  		...
					  		$message = $this->input->post('message');
					 		  ...
					 		  $this->load->library('email');
								...
								$this->email->from($rwadmin['email'], $this->site_setting['company_name']);
                 $msg="<table><tr><td>".$message."<td></tr>
				 <tr><td>&nbsp;</td><tr>
				 <tr><td>Thanks & Regards</td><tr>
				 <tr><td>".$this->site_setting['company_name']."</td><tr>
				 </table>";
