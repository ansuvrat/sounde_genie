...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active">Individual Services</li>
</ol>
</div>
</div>
<!-- Breadcrumb End -->
...
<div class="container">
<div class="cms">
<h1 class="text-center">Individual Services</h1>

<div class="mb-4">
<div class="row">

<div class="col-6 no_pad">
<a href="<?php echo site_url("member/soundproduction");?>">
...
<div class="col-6 no_pad">
<a href="<?php echo site_url("member/musicproduction");?>">
<div class="hwork_item">
<div class="hw_img">
