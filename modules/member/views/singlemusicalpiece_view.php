...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active">Single Musical Piece</li>
</ol>
</div>
</div>
<!-- Breadcrumb End -->
...
<h1 class="mb-2 text-center purple2">Single Musical Piece</h1>
<?php echo form_open_multipart("member/singlemusicalpiece");?>
<div class="reg_box">
<div>
<div class="row">
...
<div class="col-md-12 no_pad mt-2"><select name="duration" onChange="getsinglemusicalpieceprice(this.value)">
...
<div class="col-md-12 no_pad mt-2" id="singlemusicalpiecepriceID"><input name="price" type="text" placeholder="Price *" value="<?php echo set_value('price');?>" readonly>
