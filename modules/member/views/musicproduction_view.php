...
<div class="work_box">
<?php if($composition_youtube !=''){?>
<p class="youtube_icon"><a data-fancybox="" data-type="iframe" data-src="https://www.youtube.com/embed/<?php echo $composition_youtube;?>" href="javascript:void(0);" class="pop2" title=""><i class="fab fa-youtube"></i></a></p>
<?php } ?>
<div class="circle-container">
  ...
  <a href="<?php echo site_url("member/composition");?>">
...
<p class="work_title"><a href="<?php echo site_url("member/composition");?>">Composition</a></p>
<p class="work_desc"><?php echo $composition;?></p>
<p><a href="<?php echo site_url("member/composition");?>" class="readmore">Read More</a></p>
</div>
...
<div class="col-md-6 col-lg-3 no_pad">
<div class="work_box">
<?php if($lyrics_youtube !=''){?>
<p class="youtube_icon"><a data-fancybox="" data-type="iframe" data-src="https://www.youtube.com/embed/<?php echo $lyrics_youtube;?>" href="javascript:void(0);" class="pop2" title=""><i class="fab fa-youtube"></i></a></p>
<?php } ?>
<div class="circle-container">
  <div class="quarter top-left"></div>
  <div class="quarter top-right"></div>
  <div class="quarter bottom-left"></div>
  <div class="quarter bottom-right"></div>
 <a href="<?php echo site_url("member/lyrics");?>">
...
<p class="work_title"><a href="<?php echo site_url("member/lyrics");?>">Lyrics</a></p>
<p class="work_desc"><?php echo $lyrics;?></p>
<p><a href="<?php echo site_url("member/lyrics");?>" class="readmore">Read More</a></p>
</div>
</div>

<div class="col-md-6 col-lg-3 no_pad">
<div class="work_box">
<?php if($mixing_youtube !=''){?>
<p class="youtube_icon"><a data-fancybox="" data-type="iframe" data-src="https://www.youtube.com/embed/<?php echo $mixing_youtube;?>" href="javascript:void(0);" class="pop2" title=""><i class="fab fa-youtube"></i></a></p>
<?php } ?>
<div class="circle-container">
  <div class="quarter top-left"></div>
  <div class="quarter top-right"></div>
  <div class="quarter bottom-left"></div>
  <div class="quarter bottom-right"></div>
  <a href="<?php echo site_url("member/mixing");?>">
...
<p class="work_title"><a href="<?php echo site_url("member/mixing");?>">Mixing</a></p>
<p class="work_desc"><?php echo $mixing;?></p>
<p><a href="<?php echo site_url("member/mixing");?>" class="readmore">Read More</a></p>
</div>
</div>

<div class="col-md-6 col-lg-3 no_pad">
<div class="work_box">
<?php if($mastering_youtube !=''){?>
<p class="youtube_icon"><a data-fancybox="" data-type="iframe" data-src="https://www.youtube.com/embed/<?php echo $mastering_youtube;?>" href="javascript:void(0);" class="pop2" title=""><i class="fab fa-youtube"></i></a></p>
<?php } ?>
<div class="circle-container">
  <div class="quarter top-left"></div>
  <div class="quarter top-right"></div>
  <div class="quarter bottom-left"></div>
  <div class="quarter bottom-right"></div>
  <a href="<?php echo site_url("member/mastering");?>">
...
<p class="work_title"><a href="<?php echo site_url("member/mastering");?>">Mastering</a></p>
<p class="work_desc"><?php echo $mastering;?></p>
<p><a href="<?php echo site_url("member/mastering");?>" class="readmore">Read More</a></p>
</div>
</div>
