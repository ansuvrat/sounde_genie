...
/* Get meta tags  from  tbl_meta_tags */
...
/* Use  to insert all default page meta into  tbl_meta_tags  */
...

{
...

	{
...

		{
			...
			$ci->db->update("tbl_meta_tags",array('page_url'=>$page_url),$where,FALSE);
...

{
...

	{
...

		 {
			  ...
			  $ci->db->insert("tbl_meta_tags",$data);			 
