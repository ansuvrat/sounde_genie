...
<input name="subscriber_name" id="name" type="text" placeholder="Name *" class="p-2 w-100" value="<?php echo set_value("subscriber_name");?>">
<?php echo form_error('subscriber_name');?>
</div>
<div class="mt-2"><input name="subscriber_email" id="subscriber_email" type="text" placeholder="Email ID *" class="p-2 w-100" value="<?php echo set_value('subscriber_email');?>">
<?php echo form_error('subscriber_email');?>
</div>
<div class="mt-2">
  <div><input name="verification_code" type="text" style="width:100px" class="p-2" placeholder="Enter Code *">
  ...
  <p class="mt-2 fs13">Type the characters shown above.</p>
</div>
<p class="mt-2"><input name="" type="submit" class="btn btn-yel" value="Subscribe">
<input type="hidden" name="sub_type" value="sub">
 </p>
</div>
<?php echo form_close();?>
</body>
